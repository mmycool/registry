class Registrant::ContactsController < RegistrantController
  ...
  def show
    @contact = Contact.where(id: current_registrant_user.contacts).find_by(id: params[:id])

    authorize! :read, @contact
  end

  def edit
    @contact = Contact.where(id: current_registrant_user.contacts).find(params[:id])
  end
  ...
  def domain
    current_registrant_user.domains.find(params[:domain_id])
  end
