...
--
-- Name: invoice_buyer_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY invoices
    ADD CONSTRAINT invoice_buyer_id_fk FOREIGN KEY (buyer_id) REFERENCES registrars(id);
...
INSERT INTO schema_migrations (version) VALUES ('20171107170127');

INSERT INTO schema_migrations (version) VALUES ('20171107172544');
...
INSERT INTO schema_migrations (version) VALUES ('20171109170326');

INSERT INTO schema_migrations (version) VALUES ('20171109172012');

INSERT INTO schema_migrations (version) VALUES ('20171110103538');
...
INSERT INTO schema_migrations (version) VALUES ('20171129031038');
